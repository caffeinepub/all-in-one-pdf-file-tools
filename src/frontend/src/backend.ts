...
export class Backend implements backendInterface {
    ...
    async getAllPreferences(): Promise<Array<string>> {
    ...
    async getHistory(): Promise<Array<ToolUsage>> {
        if (this.processError) {
            try {
    ...
    async hasPreference(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPreference(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logToolUsage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logToolUsage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePreference(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePreference(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
